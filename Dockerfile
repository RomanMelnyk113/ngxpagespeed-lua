...
ARG MOD_PAGESPEED_TAG=latest-stable
...
ARG NGX_PAGESPEED_TAG=v1.14.33.1-RC1
...
RUN wget https://github.com/openresty/lua-nginx-module/archive/refs/tags/v0.10.14.tar.gz && \
...
RUN tar zxf ../nginx-${NGINX_VERSION}.tar.gz --strip-components=1 -C . && \
    ...
    --add-module=/usr/src/lua-nginx-module-0.10.14 \
